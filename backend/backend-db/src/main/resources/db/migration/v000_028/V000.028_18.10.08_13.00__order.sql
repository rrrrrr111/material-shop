CREATE TABLE SHOP_ORDER (
  ...
  SHOP_IDENTITY      VARCHAR(100) NOT NULL,
  CLIENT_PERSON_ID   BIGINT       NOT NULL REFERENCES PERSON (ID),
  PERSON_ADDRESS_ID  BIGINT REFERENCES PERSON_ADDRESS (ID),
  GOODS_AMOUNT       BIGINT,
...
SELECT setval('SHOP_ORDER_ID_SEQ', 1033, true);
...
CREATE INDEX IDX_SOR_ADDRESS_ID
  ON SHOP_ORDER (PERSON_ADDRESS_ID);
