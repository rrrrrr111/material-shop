CREATE TABLE SHOP_ORDER (
  ...
  CLIENT_PERSON_ID   INT          NOT NULL REFERENCES PERSON (ID),
  ADDRESS_ID         INT REFERENCES ADDRESS (ID),
  AMMOUNT            BIGINT,
  STATE              VARCHAR(100) NOT NULL,
  ASSIGNED_PERSON_ID INT REFERENCES PERSON (ID),
...
CREATE TABLE SHOP_ORDER_HISTORY (
  ...
  OLD_ASSIGNED_PERSON_ID INT REFERENCES PERSON (ID),
  NEW_STATE              VARCHAR(100) NOT NULL,
  NEW_SERVICE_COMMENT    VARCHAR(10000),
  NEW_ASSIGNED_PERSON_ID INT REFERENCES PERSON (ID),
