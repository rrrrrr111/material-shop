...
public class ProductCosmetic extends TableImpl<ProductCosmeticRecord> {
     ...
     */
    public static final ProductCosmetic PRODUCT_COSMETIC = new ProductCosmetic();
     ...
     */
    public ProductCosmetic(String alias) {
     ...
     * Create an aliased <code>matshop.product_cosmetic</code> table reference
     */
    public ProductCosmetic(Name alias) {
        this(alias, PRODUCT_COSMETIC);
    }

    private ProductCosmetic(Name alias, Table<ProductCosmeticRecord> aliased) {
        this(alias, aliased, null);
    }

    private ProductCosmetic(Name alias, Table<ProductCosmeticRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> ProductCosmetic(Table<O> child, ForeignKey<O, ProductCosmeticRecord> key) {
     ...
     */
    @Override
    public ProductCosmetic as(String alias) {
        return new ProductCosmetic(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public ProductCosmetic as(Name alias) {
        return new ProductCosmetic(alias, this);
    }
     ...
     */
    @Override
    public ProductCosmetic rename(String name) {
        return new ProductCosmetic(DSL.name(name), null);
    }
     ...
     */
    @Override
    public ProductCosmetic rename(Name name) {
        return new ProductCosmetic(name, null);
    }
}
