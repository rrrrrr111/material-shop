...
public class TechLog extends TableImpl<TechLogRecord> {

    private static final long serialVersionUID = -1433613120;

    /**
     * The reference instance of <code>matshop.tech_log</code>
     */
    public static final TechLog TECH_LOG = new TechLog();
     ...
     * Create an aliased <code>matshop.tech_log</code> table reference
     */
    public TechLog(Name alias) {
        this(alias, TECH_LOG);
    }

    private TechLog(Name alias, Table<TechLogRecord> aliased) {
        this(alias, aliased, null);
    }

    private TechLog(Name alias, Table<TechLogRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> TechLog(Table<O> child, ForeignKey<O, TechLogRecord> key) {
     ...
     */
    @Override
    public TechLog as(String alias) {
        return new TechLog(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public TechLog as(Name alias) {
        return new TechLog(alias, this);
    }
     ...
     */
    @Override
    public TechLog rename(String name) {
        return new TechLog(DSL.name(name), null);
    }
     ...
     */
    @Override
    public TechLog rename(Name name) {
        return new TechLog(name, null);
    }
}
