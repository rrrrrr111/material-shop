 ...
 */
@Component
class ExcelStreamReporter extends CreatorHolder<ExcelStreamCreator> {
    ...
    private <D> ReportForm createReportForm(ExcelStreamCreator creator, D data, String formFilename) {
